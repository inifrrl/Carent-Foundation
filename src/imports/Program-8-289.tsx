import svgPaths from "./svg-ghwdwuqmn0";
import imgUntitledDesign141 from "figma:asset/f86f6d63333b643522d3c5b5ffc82aa8977146ec.png";
import imgUntitledDesign61 from "figma:asset/bc8e73d16ce977931829059b3a85aeebc954a2ad.png";
...
function Navigation() {
  return (
    <div className="h-[150px] mb-[-14px] relative shrink-0 w-full" data-name="Navigation">
...
function LogoLogoCarent() {
  return (
    <div className="col-1 h-[119.07px] ml-[676.25px] mt-[22.61px] relative row-1 shadow-[-5px_7px_4px_0px_rgba(0,0,0,0.25)] w-[101.43px]" data-name="Logo/Logo Carent 1">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group4() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[626.26px] mt-[32.79px] place-items-start relative row-1">
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[82px] justify-end ml-0 mt-[100px] relative row-1 text-[#1e08b1] text-[80px] w-[814.743px]">
        <p className="leading-[normal] whitespace-pre-wrap">STATEMENT</p>
      </div>
      <div className="col-1 flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[100px] justify-end ml-0 mt-0 relative row-1 text-[#1e08b1] text-[92.016px] w-[778.262px]">
...
function Logo1() {
  return (
    <div className="h-[347.939px] relative w-[184.378px]" data-name="Logo">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group6() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] mb-[-14px] place-items-start relative shrink-0">
      <div className="col-1 flex h-[768px] items-center justify-center ml-[0.25px] mt-0 relative row-1 w-[537.082px]" style={{ "--transform-inner-width": "1184.796875", "--transform-inner-height": "21.59375" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-[537.082px] relative w-[768px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 768 537.082">
              <path d={svgPaths.p36b7d772} fill="var(--fill-0, #1E08B1)" id="Polygon 1" />
            </svg>
          </div>
        </div>
      </div>
      <div className="col-1 h-[545.497px] ml-0 mt-[175.98px] relative row-1 w-[605.126px]" data-name="Untitled design-6 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[155.47%] left-[-63.14%] max-w-none top-[-31.38%] w-[249.27%]" src={imgUntitledDesign61} />
        </div>
      </div>
      <Group4 />
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[560px] justify-end ml-[626px] mt-[249.79px] relative row-1 text-[#1e08b1] text-[24px] tracking-[2.4px] w-[748px] whitespace-pre-wrap">
        <p className="mb-0">
      ...
      <div className="col-1 flex h-[184.378px] items-center justify-center ml-[179.51px] mt-[676.57px] relative row-1 w-[347.939px]" style={{ "--transform-inner-width": "1184.796875", "--transform-inner-height": "21.59375" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <Logo1 />
        </div>
      </div>
...
function Group8() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[670.06px] mt-[209.42px] place-items-start relative row-1">
      <div className="col-1 h-[200.755px] ml-0 mt-0 relative row-1 w-[357.073px]" data-name="Untitled design-8 1">
...
function Group9() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[229.68px] mt-[209.42px] place-items-start relative row-1">
      ...
      <div className="col-1 h-[200.681px] ml-[59.86px] mt-0 relative row-1 w-[212.252px]" data-name="13 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group7() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1095.7px] mt-[220.6px] place-items-start relative row-1">
      ...
      <div className="col-1 h-[204.633px] ml-[69.31px] mt-0 relative row-1 w-[209.337px]" data-name="Untitled design-13 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group11() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] mb-[-14px] place-items-start relative shrink-0">
      <Group8 />
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[87.426px] justify-center ml-[115.89px] mt-0 relative row-1 text-[#1e08b1] text-[100px] w-[804.919px]">
      ...
      <div className="col-1 flex flex-col font-['Work_Sans:Bold',sans-serif] font-bold h-[28.464px] justify-end ml-[124.32px] mt-[87.43px] relative row-1 text-[#1e08b1] text-[24px] w-[796.49px]">
...
function Group5() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[38.22px] mt-[444.57px] place-items-start relative row-1">
      <div className="bg-[#1e08b1] col-1 h-[48.389px] ml-0 mt-0 row-1 w-[843.004px]" />
      <div className="col-1 font-['Work_Sans:Regular',sans-serif] font-normal h-[169.361px] ml-[13.43px] mt-[69.56px] relative row-1 text-[#1e08b1] text-[24px] w-[388.443px] whitespace-pre-wrap">
      ...
      <div className="col-1 font-['Work_Sans:Regular',sans-serif] font-normal h-[169.361px] ml-[478.32px] mt-[69.56px] relative row-1 text-[#1e08b1] text-[24px] w-[431.833px] whitespace-pre-wrap">
      ...
      <div className="bg-[#1e08b1] col-1 h-[48.389px] ml-0 mt-[286.3px] row-1 w-[840.938px]" />
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] ml-[11.36px] mt-[355.86px] relative row-1 text-[#1e08b1] text-[24px] w-[388.443px] whitespace-pre-wrap">
      ...
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] ml-[476.26px] mt-[355.86px] relative row-1 text-[#1e08b1] text-[24px] w-[433.899px] whitespace-pre-wrap">
      ...
      <div className="bg-[#1e08b1] col-1 h-[48.389px] ml-0 mt-[572.6px] row-1 w-[854.368px]" />
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] ml-[11.36px] mt-[642.16px] relative row-1 text-[#1e08b1] text-[24px] w-[388.443px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Strategic Focus</p>
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p>
      ...
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] ml-[476.26px] mt-[642.16px] relative row-1 text-[#1e08b1] text-[24px] w-[433.899px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Program Orientation</p>
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p>
          <span className="font-['Work_Sans:Regular',sans-serif] font-normal leading-[normal]">{`Position youth development as a `}</span>
      ...
      <div className="bg-[#1e08b1] col-1 h-[48.389px] ml-0 mt-[856.89px] row-1 w-[921.519px]" />
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] ml-[11.36px] mt-[926.45px] relative row-1 text-[#1e08b1] text-[24px] w-[388.443px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Strategic Focus</p>
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p>
      ...
      <div className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[169.361px] leading-[normal] ml-[476.26px] mt-[926.45px] relative row-1 text-[#1e08b1] text-[24px] w-[445.263px] whitespace-pre-wrap">
      ...
      <div className="col-1 h-[1134.31px] ml-[1036.06px] mt-[56.26px] relative row-1 w-[336.924px]" data-name="Untitled design-16 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group10() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] mb-[-14px] place-items-start relative shrink-0">
      <p className="col-1 font-['Work_Sans:Medium',sans-serif] font-medium h-[119px] ml-[62px] mt-[271px] relative row-1 text-[#1e08b1] text-[24px] text-center w-[1306px] whitespace-pre-wrap">
      ...
      <div className="col-1 font-['Work_Sans:Bold',sans-serif] font-bold h-[235.896px] leading-[85px] ml-[609.53px] mt-[13.11px] relative row-1 text-[#1e08b1] text-[100px] w-[825.442px] whitespace-pre-wrap">
...
export default function Program() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start pb-[14px] relative size-full" data-name="Program">
      <Navigation />
      <Group6 />
      <Group11 />
      <Group10 />
