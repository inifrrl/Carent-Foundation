import svgPaths from "./svg-e3q4l57xmc";
...
function LogoLogoCarent() {
  return (
    <div className="col-1 h-[118.252px] ml-[666.65px] mt-[23.02px] relative row-1 w-[100.734px]" data-name="Logo/Logo Carent 1">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group4() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[637.41px] mt-[44.79px] place-items-start relative row-1">
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[82px] justify-end ml-0 mt-[100px] relative row-1 text-[#1e08b1] text-[80px] w-[803.589px]">
        <p className="leading-[normal] whitespace-pre-wrap">STATEMENT</p>
      </div>
      <div className="col-1 flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[100px] justify-end ml-0 mt-0 relative row-1 text-[#1e08b1] text-[92.016px] w-[767.608px]">
...
function Logo1() {
  return (
    <div className="h-[345.549px] relative w-[183.112px]" data-name="Logo">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Group6() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <Group4 />
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[560px] justify-end ml-[637.16px] mt-[261.79px] relative row-1 text-[#1e08b1] text-[24px] tracking-[2.4px] w-[737.76px] whitespace-pre-wrap">
        <p className="mb-0">
      ...
      <div className="col-1 h-[443px] ml-[116px] mt-[123px] relative row-1 w-[459px]" data-name="pazelll 4 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
