...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative size-full" data-name="Program Mobile">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[107px] justify-end leading-[0] left-[89px] text-[#1e08b1] text-[0px] text-justify top-[330px] tracking-[0.85px] w-[277px]">
