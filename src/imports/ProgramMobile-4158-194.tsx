...
function Group5() {
  return (
    <div className="absolute contents left-[53.58px] top-[388.85px]">
      ...
      <div className="-translate-x-1/2 -translate-y-full absolute flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[18.971px] justify-end leading-[0] left-[92.41px] text-[#1e08b1] text-[7.465px] text-center top-[467.1px] w-[77.66px]">
...
function Group3() {
  return (
    <div className="absolute contents left-[255.59px] top-[391.46px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[6.403px] leading-[normal] left-[293.81px] text-[#1e08b1] text-[5.132px] text-center top-[526.86px] w-[60.703px] whitespace-pre-wrap">National Orientation</p>
          ...
          <div className="h-0 relative w-[5.454px]">
            <div className="absolute inset-[-1.72px_-4.28%_-1.72px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.68739 3.43554">
                <path d={svgPaths.pc0fa500} fill="var(--stroke-0, #1E08B1)" id="Arrow 3" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[6.403px] leading-[normal] left-[294.42px] text-[#1e08b1] text-[5.132px] text-center top-[509.32px] w-[61.932px] whitespace-pre-wrap">{`Ecosystem Orientation `}</p>
      ...
      <div className="-translate-x-1/2 absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[6.166px] leading-[normal] left-[294.42px] text-[#1e08b1] text-[5.132px] text-center top-[476.12px] w-[61.932px] whitespace-pre-wrap">
        <p className="mb-0">{`Capability Orientation `}</p>
        <p>&nbsp;</p>
      </div>
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Medium',sans-serif] font-medium h-[6.166px] leading-[normal] left-[294.3px] text-[#1e08b1] text-[5.132px] text-center top-[492.95px] w-[59.72px] whitespace-pre-wrap">Career Orientation</p>
      ...
      <div className="-translate-x-1/2 -translate-y-full absolute flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[24.425px] justify-end leading-[0] left-[295.28px] text-[#1e08b1] text-[7.465px] text-center top-[467.1px] w-[79.381px]">
...
function Group7() {
  return (
    <div className="absolute contents left-0 top-[340px]">
      <Group4 />
      <div className="-translate-y-1/2 absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[20.394px] justify-center leading-[0] left-[27.03px] text-[#1e08b1] text-[23.327px] top-[350.2px] w-[187.761px]">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Bold',sans-serif] font-bold h-[6.64px] justify-end leading-[0] left-[29px] text-[#1e08b1] text-[5.598px] top-[367.03px] w-[185.795px]">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[6.64px] justify-center leading-[0] left-[80.73px] text-[#1e08b1] text-[5.598px] text-center top-[370.35px] w-[102.974px]">
      ...
      <div className="absolute h-[202px] left-0 top-[345px] w-[35px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 202">
          <path d={svgPaths.pa350100} fill="var(--fill-0, #1E08B1)" id="Rectangle 3" />
        </svg>
      </div>
      <Group3 />
    </div>
...
function Group1() {
  return (
    <div className="absolute contents left-0 top-[622px]">
      ...
      <div className="absolute font-['Work_Sans:Regular',sans-serif] font-normal h-[46.257px] leading-[0] left-[3.67px] text-[#1e08b1] text-[6.555px] top-[641px] w-[106.095px] whitespace-pre-wrap">
      ...
      <div className="absolute font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[46.257px] leading-[0] left-[3.1px] text-[#1e08b1] text-[6.555px] top-[719.2px] w-[106.095px] whitespace-pre-wrap">
      ...
      <div className="absolute font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[46.257px] leading-[0] left-[3.1px] text-[#1e08b1] text-[6.555px] top-[797.39px] w-[106.095px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Strategic Focus</p>
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p>
      ...
      <div className="absolute font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[46.257px] leading-[0] left-[3.1px] text-[#1e08b1] text-[6.555px] top-[875.04px] w-[106.095px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Strategic Focus</p>
        <p className="leading-[normal] mb-0">&nbsp;</p>
        <p>
      ...
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Bold',sans-serif] font-bold h-[9.086px] leading-[normal] left-[125.85px] text-[7.648px] text-center text-white top-[857.69px] w-[251.693px] whitespace-pre-wrap">{`4. Leadership, Social Innovation & Change Agents Development`}</p>
      ...
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Bold',sans-serif] font-bold h-[9.086px] leading-[normal] left-[91.85px] text-[7.648px] text-center text-white top-[623.65px] w-[176.354px] whitespace-pre-wrap">1. Future-Ready Youth Capacity Development</p>
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Bold',sans-serif] font-bold h-[9.086px] leading-[normal] left-[102.14px] text-[7.648px] text-center text-white top-[701.85px] w-[196.953px] whitespace-pre-wrap">{`2. Career Transition & Industry Exposure Programs`}</p>
      <p className="-translate-x-1/2 absolute font-['Work_Sans:Bold',sans-serif] font-bold h-[9.086px] leading-[normal] left-[114.98px] text-[7.648px] text-center text-white top-[780.05px] w-[222.63px] whitespace-pre-wrap">3. Youth–Industry–Government Ecosystem Collaboration</p>
    </div>
  );
}
...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative size-full" data-name="Program Mobile">
        ...
        <div className="flex-none rotate-90">
          <div className="h-[110px] relative w-[284px]">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 284 110">
              <path d={svgPaths.p26909ac0} fill="var(--fill-0, #1E08B1)" id="Polygon 1" />
            </svg>
          </div>
        </div>
      </div>
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[80px] justify-end leading-[0] left-[156px] text-[#1e08b1] text-[8.786px] text-justify top-[220px] w-[210px]">
        <p className="whitespace-pre-wrap">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[55px] justify-end leading-[0] left-[89px] text-[#1e08b1] text-[0px] text-justify top-[310px] tracking-[0.85px] w-[277px]">
