...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative size-full" data-name="Program Mobile">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[80px] justify-end leading-[0] left-[149px] text-[#1e08b1] text-[8.786px] text-justify top-[213px] w-[210px]">
        <p className="whitespace-pre-wrap">
