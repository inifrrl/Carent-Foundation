...
function Group() {
  return (
    <div className="absolute contents left-[156px] top-[80px]">
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[20px] justify-end leading-[0] left-[156px] text-[#1e08b1] text-[21.802px] top-[129.6px] w-[219px]">
        <p className="leading-[normal] whitespace-pre-wrap">STATEMENT</p>
      </div>
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[25px] justify-end leading-[0] left-[156px] text-[#1e08b1] text-[25.077px] top-[107.25px] w-[209.194px]">
