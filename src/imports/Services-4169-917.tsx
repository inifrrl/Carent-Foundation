import svgPaths from "./svg-cjl8s6aaev";
...
function Group4() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid justify-self-stretch leading-[0] place-items-start relative row-2 self-start shrink-0">
      <div className="col-1 flex h-[55px] items-center justify-center ml-[192px] mt-[107px] relative row-1 w-[1000px]">
        <div className="-scale-y-100 flex-none">
          <div className="bg-[#1e08b1] h-[55px] w-[1000px]" />
        </div>
      </div>
      <div className="col-1 flex flex-col font-['Work_Sans:Regular',sans-serif] font-normal h-[45px] justify-end ml-[215.49px] mt-[107px] relative row-1 text-[32px] text-center text-white w-[965.324px]">
        <p className="leading-[normal] whitespace-pre-wrap">{`Government & BUMN Strategic Collaboration Programs`}</p>
      </div>
      <div className="col-1 flex flex-col font-['Work_Sans:ExtraBold',sans-serif] font-extrabold h-[75px] justify-center ml-[192px] mt-[16px] relative row-1 text-[#1e08b1] text-[64px] text-center w-[1000px]">
...
function Frame() {
  return (
    <div className="col-1 gap-x-[21px] gap-y-[16px] grid grid-cols-[_1000px] grid-rows-[__0.00px_fit-content(100%)] ml-0 mt-0 pl-[192px] pr-[180px] relative row-1 w-[1372px]">
      <Group4 />
    </div>
  );
}
...
function Group7() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 ml-[-15px]">
      <div className="col-1 h-[103px] ml-0 mt-[96px] relative row-1 w-[531px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 531 103">
