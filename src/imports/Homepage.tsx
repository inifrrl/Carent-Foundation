...
function Group5() {
  return (
    <div className="w-full py-16 overflow-x-auto">
      {/* Container dengan min-width agar bentuk diagram tidak hancur di layar kecil (bisa di-scroll ke samping) */}
      <div className="min-w-[1024px] flex flex-col items-center justify-center mx-auto">

        {/* --- BARIS 1 (Atas) --- */}
        <div className="flex items-end justify-center gap-[60px] -mb-8 z-0">
          {/* Private Sector */}
          <div className="relative flex items-center justify-center w-[256px] h-[140px] hover:scale-105 transition-transform duration-300">
            ...
            <p className="relative z-10 font-['Work_Sans',sans-serif] text-white text-[17px] text-center px-4 leading-tight">
              {`Private Sector &\nIndustry Partnership`}
            </p>
          </div>

          {/* Panah (Arrow) */}
          <div className="flex flex-col items-center justify-end h-[140px] pb-6">
            <div className="rotate-90 w-[74px] h-[15px]">
        ...
        {/* --- BARIS 2 (Tengah) --- */}
        <div className="flex items-center justify-center gap-[40px] z-10 relative">
          {/* Academic */}
          <div className="relative flex items-center justify-center w-[256px] h-[140px] hover:scale-105 transition-transform duration-300">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="-rotate-90 w-[140px] h-[256px]">
          ...
          <div className="relative flex items-center justify-center w-[289px] h-[158px] hover:scale-105 transition-transform duration-300">
            ...
            <p className="relative z-10 font-['Work_Sans',sans-serif] font-semibold text-[#1e08b1] text-[28px] text-center leading-tight">
              PARTNER<br/>TYPE
            </p>
          </div>
          ...
          <div className="relative flex items-center justify-center w-[278px] h-[147px] hover:scale-105 transition-transform duration-300">
            ...
            <p className="relative z-10 font-['Work_Sans',sans-serif] text-white text-[17px] text-center px-6 leading-tight">
        ...
        {/* --- BARIS 3 (Bawah) --- */}
        <div className="flex items-start justify-center gap-[180px] -mt-10 z-0">
          {/* Community */}
          <div className="relative flex items-center justify-center w-[242px] h-[129px] hover:scale-105 transition-transform duration-300">
            ...
            <p className="relative z-10 font-['Work_Sans',sans-serif] text-white text-[16px] text-center px-4 leading-tight">
              {`Community & Civil\nSociety Partnership`}
            </p>
          </div>

          {/* BUMN */}
          <div className="relative flex items-center justify-center w-[179px] h-[85px] hover:scale-105 transition-transform duration-300 mt-4">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            ...
            <p className="relative z-10 font-['Work_Sans',sans-serif] text-white text-[15px] text-center leading-tight">
              BUMN Partnership
            </p>
          </div>
        </div>
