...
        </div>
      </div>
      <p className="col-1 font-['Work_Sans:SemiBold',sans-serif] font-semibold h-[39px] leading-[normal] ml-[500px] mt-[242px] relative row-1 text-[#1e08b1] text-[30px] w-[226px] whitespace-pre-wrap">PARTNER TYPE</p>
