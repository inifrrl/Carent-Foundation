...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative w-full h-[960px] page-transition" data-name="Program Mobile">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans',sans-serif] font-normal h-[80px] justify-end leading-[0] left-[156px] text-[#1e08b1] text-[8.786px] text-justify top-[219px] w-[210px]">
        <p className="whitespace-pre-wrap">
