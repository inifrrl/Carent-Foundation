...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative w-full min-h-[1350px] overflow-hidden page-transition" data-name="Program Mobile">
      <Group />
      ...
      <div className="translate-y-[280px]">
        ...
        <p className="absolute font-['Work_Sans',sans-serif] font-bold h-[13px] leading-[0] left-[151px] text-[#1e08b1] text-[15.17px] top-[547px] w-[220px] whitespace-pre-wrap">
