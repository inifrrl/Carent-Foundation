...
export default function ProgramMobile() {
  return (
    <div className="bg-white relative w-full h-[960px] page-transition" data-name="Program Mobile">
      ...
      <div className="-translate-y-full absolute flex flex-col font-['Work_Sans',sans-serif] font-normal h-[87px] justify-end leading-[0] left-[89px] text-[#1e08b1] text-[0px] text-justify top-[320px] tracking-[0.85px] w-[297px]">
